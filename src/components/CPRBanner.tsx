...
export const CPRBanner = () => {
  return (
    <section className="py-14 sm:py-16 md:py-20 px-5 sm:px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="bg-card/60 border border-border/30 rounded-2xl backdrop-blur-sm overflow-hidden">
          <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-12 p-6 sm:p-8 md:p-12 lg:p-16">
            
            {/* Left: Content */}
            <div className="flex-1 text-center lg:text-left">
              {/* Icon cluster */}
              <div className="flex items-center justify-center lg:justify-start mb-5 sm:mb-6">
                <img src={bhfLogo} alt="British Heart Foundation" className="h-24 sm:h-32 md:h-40 rounded-xl object-contain" />
              </div>

              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-foreground tracking-tight leading-[1.15] sm:leading-[1.1] mb-4">
                Learn CPR in 15 Minutes.{" "}
                <span className="text-cpr">
Save a Life.</span>
              </h2>

              <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-[1.7] sm:leading-relaxed max-w-xl mx-auto lg:mx-0 mb-6 sm:mb-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-4">
                <Button size="lg"
                className="bg-cpr text-cpr-foreground hover:bg-cpr/90 transition-all hover:scale-105 text-base px-8 py-6 font-semibold w-full sm:w-auto"
                asChild>
