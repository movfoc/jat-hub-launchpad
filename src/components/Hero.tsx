...
export const Hero = () => {
  ...
  return (
    <section 
      id="hero"
      className="min-h-screen flex items-center justify-center text-center px-5 sm:px-6 pt-24 relative isolate hero-overlay"
      style={{
    ...
    >
      <div className="max-w-4xl mx-auto relative z-10">
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white tracking-tighter mb-6 leading-[1.1]">
          The Power of Youth, <span className="text-primary">United</span>
        </h1>
        <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-foreground/70 leading-relaxed">
